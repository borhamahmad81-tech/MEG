...
class RulesEngine:
    ...
    def find_matching_rule(self, event_code: str, free_text: str):
        ...
        - If it has multiple rows but NONE match, returns None -- since a
          save can't be undone later, the app must NOT guess; the record
          is skipped and logged for manual review instead.
        """
