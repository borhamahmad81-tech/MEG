...
class AutomationWorker(threading.Thread):
    ...
    def _apply_fields(self, define_text, causes):
        ...
        # The Root Cause Analysis section is collapsed by default and its
        # fields aren't interactable until expanded.
        self.browser.expand_section_by_heading_text("Root Cause analysis tools")
